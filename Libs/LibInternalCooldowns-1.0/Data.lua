...
local spellToItem = {
--	[buff] = item associé
	[71636] = 50365,	-- Phylactery héro
	[71605] = 50360,	-- Phylactery
...
local cooldowns = {	
	[71636] = 100,	-- Phylactery héro
	[71605] = 100,	-- Phylactery
	
	[55637] = 60,	-- Enchant cape, c'est 45 sec qui trigger à la fin du buff (durée 15 sec), flemme de trouver comment changer ça
